...
class Login(BoxLayout):
    def __init__(self, arg1=None, arg2=None, **kwargs):
        ...
        self.add_widget(Label(text="LOGIN", font_size=40, font_name='Georgia', color=get_color_from_hex('#1E90FF')))
        ...
        self.add_widget(Label(text="Nome de usuário:", font_name='Arial', color=get_color_from_hex('#32CD32'), font_size=20))
        self.add_widget(self.username_input)
        self.add_widget(Label(text="Senha:", font_name='Arial', color=get_color_from_hex('#32CD32'), font_size=20))
...
class NewWindow(BoxLayout):
    def __init__(self, arg1, arg2, **kwargs):
        ...
        self.add_widget(Label(text='Tela Cadastro', font_size=40, font_name='Georgia', color=get_color_from_hex('#1E90FF')))
        ...
        self.add_widget(Label(text="Nome de usuário:", font_name='Arial', color=get_color_from_hex('#32CD32'), font_size=20))
        self.add_widget(self.username_input)
        self.add_widget(Label(text="Email:", font_name='Arial', color=get_color_from_hex('#32CD32'), font_size=20))
        self.add_widget(self.email_input)
        self.add_widget(Label(text="Celular:", font_name='Arial', color=get_color_from_hex('#32CD32'), font_size=20))
